<template>
  ...
  >
    <div style="text-align: center; padding: 20px 0;">
      ...
      <p v-if="status === 'running'" style="color: #909399; font-size: 13px;">
        可以关闭此窗口，生成将在后台继续进行
      </p>

      <p v-if="errorMessage" style="color: #f56c6c; font-size: 13px;">
        {{ errorMessage }}
      </p>

      <p v-if="tokenUsage" style="color: #909399; font-size: 12px;">
